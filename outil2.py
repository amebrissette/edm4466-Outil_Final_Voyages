...
for destination in destinations:
    ...
    f = open(moisson, encoding="iso-8859-1")
    alertes = csv.reader(f)
    ...
    for alerte in alertes:
        ...
        print(nouvelAvertissement) # *** COMMENT APPEND MES VALEURS DE LA BOUCLE TRY/EXCEPT SANS RÉPÉTITION???
        
        alertes = open(fichier2,"a", encoding="utf-8")
        outil2voyage = csv.writer(alertes)
        outil2voyage.writerow(nouvelAvertissement) 
        # Ouverture du fichier csv contenant toutes données actualisées.  *** FICHIER CSV NE SE CRÉE PAS
